...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("status", sa.String(30), nullable=False),
        *_counts(),
        sa.Column("within_run_duplicate_count", sa.Integer(), server_default="0", nullable=False),
        sa.Column("database_duplicate_count", sa.Integer(), server_default="0", nullable=False),
